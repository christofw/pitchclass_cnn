...
def subplot_matrixTI_colorbar(S, fig, ax, title='', Fs=1, xlabel='Time (seconds)', ylabel='Time (seconds)',
    ...
    if cmap is None:
        ...
        colorList = np.array([color_ind_zero, [1,1,0,1],  [0,0.7,0,1],  [1,0,1,1],  [0,0,1,1],  [1,0,0,1],
                         [0,0,0,0.5],[1,0,0,0.3],[0,0,1,0.3],[1,0,1,0.3],[0,0.7,0,0.3],[1,1,0,0.3]])
