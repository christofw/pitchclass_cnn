"""
Module: LibFMP.C3.C3S1_TranspositionTuning
...
def compute_freq_distribution(x, Fs, N=16384, gamma=100, local=True, filt=True, filt_len=101):
    ...
    if local:
        ...
        Y, T_coef, F_coef= LibFMP.C2.stft_conventionFMP(x=x, Fs=Fs, N=N, H=N//2, mag=True, gamma=gamma)
...
def plot_tuning_similarity(sim, theta_axis, theta_max, ax=None, title=None, figsize=(4, 3)):
    ...
    Args:
        ...
        theta_max: Similarity maximizing index
...
def plot_freq_vector_template(v, F_coef_cents, template_max, ax=None, title=None, figsize=(8, 3)):
