...
# Adam optimizer proved to work well; if loss explodes after a few iterations, reduce learning rate
...
modelName = datetime.datetime.now().strftime(format = "%Y-%m-%d_%H-%M-%S") + 'mCNN_trainMusicNet-BeethovenPiano-WagnerPianoScore'
###################################################################################
numValFiles = 100
